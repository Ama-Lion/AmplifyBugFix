...
export default function GestionNumerique({ values, handleChange }) {
    return (
        <div>
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q192')} defaultValue={values.q192} label={"192. Quelle est l'age moyen de votre parc informatique (ordinateurs, tablettes) ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q200')} defaultValue={values.q200} label={"200.  Avez-vous pris d'autres mesures pour la suppression des emails inutiles ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q210')} defaultValue={values.q210} label={"210. Quelle est la stratégie pour dématérialiser cette partie administrative (Question ouverte) ?"} />
