...
export default function Transports({ values, handleChange }) {
    return (
        <div>
                    ...
                    <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q89')} defaultValue={values.q89} label={"89. Si Oui, quels sont les critères de priorisation (budget, distance, fatigue pour les joueurs...) ?"} />
                    ...
                    <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q98')} defaultValue={values.q98} label={"98. Si oui, pouvez-vous nous le décrire ?"} />
                    ...
                    <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q109')} defaultValue={values.q109} label={"109. Si oui, quelles mesures avez-vous mis en place ? (Ex : places de parking prioritaires)"} />
                    ...
                    <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q111')} defaultValue={values.q111} label={"111. Si oui, quelles mesures avez-vous prises ?"} />
                    ...
                    <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q114')} defaultValue={values.q114} label={"114. Si oui, quelles mesures avez-vous prises ?"} />
                    ...
                    <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q116')} defaultValue={values.q116} label={"116. Si oui, quelles mesures avez-vous prises ?"} />
                    ...
                    <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q121')} defaultValue={values.q121} label={"121. Si Oui, pouvez-vous les décrire ?"} />
        </div>
    )
}
