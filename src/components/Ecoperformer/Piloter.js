...
export default function Piloter({ values, handleChange }) {
    return (
        <div>
                ...
                <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q69')} defaultValue={values.q69} label={`69. Si Oui, Quel(s) objectif(s) avez-vous pris part ? Et sous quelles formes d’engagement ? `} />
                ...
                <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q72')} defaultValue={values.q72} label={"72. Si Oui, Quel est le nom de cette structure ? Et en quelle année a-t-elle été créé ?"} />
                <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q73')} defaultValue={values.q73} label={"73. Quel est l’objet social de cette structure ?"} />
                ...
                <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q76')} defaultValue={values.q76} label={"76. Si Oui, est-il possible de nous partager ce plan d’actions ?"} />
                ...
                <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q78')} defaultValue={values.q78} label={"78. Quel est le contact référent DD (Nom – Prénom – Poste) ?"} />
                <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q79')} defaultValue={values.q79} label={"79. Quels sont les membres de la commission DD (Nom – Prénom – Poste) ?"} />
                ...
                <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q81')} defaultValue={values.q81} label={"81. Si Oui, merci d’indiquer les Nom & Prénom :"} />
                ...
                <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q83')} defaultValue={values.q83} label={"83. Si Oui, pouvez-vous les partager ?"} />
                ...
                <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q86')} defaultValue={values.q86} label={"86. Si Oui, par quel(s) moyen(s) de promotion ?"} />
        </div>
    )
}
