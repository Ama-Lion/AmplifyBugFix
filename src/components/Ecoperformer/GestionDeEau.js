...
export default function GestionDeEau({ values, handleChange }) {
    return (
        <div>
            ...
            <TextFieldInput onChange={handleChange('166')} defaultValue={values.q166} label={"166. Si, Oui pouvez-vous nous communiquer cette consommation ? Eau chaude ? Eau froide ? (stade, gymnase , centre d'entrainement...)"} />
            ...
            <TextFieldInput onChange={handleChange('q168')} defaultValue={values.q168} label={"168. Si Oui, quel système avez-vous privilégié ?"} />
            ...
            <TextFieldInput onChange={handleChange('q177')} defaultValue={values.q177} label={"177. Si Oui, pouvez-vous décrire le système ?"} />
