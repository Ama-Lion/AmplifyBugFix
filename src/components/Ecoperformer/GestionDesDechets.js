...
export default function GestionDesDechets({ values, handleChange }) {
    return (
        <div>
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q140')} defaultValue={values.q140} label={"140. Si Oui, Comment cela représente il ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q144')} defaultValue={values.q144} label={"144. Si Oui, Comment pourrait-il être perfectible ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q154')} defaultValue={values.q154} label={"154. À quelle fréquence renouvelez-vous ces Écocups ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q157')} defaultValue={values.q157} label={"157. Si Oui, merci de préciser quels matériaux vous avez choisis ? Pourquoi ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q164')} defaultValue={values.q164} label={"164. Si Oui, Qu'est-ce que vous traité ? De quelle manière est-il traité ? Et Pour qui ?"} />
