...
export default function RespectDesMlieux( { values, handleChange } ) {
    ...
    return (
        ...
        <TextFieldInput onChange={handleChange('q1')} defaultValue={values.q1} label={"1. Où sont situées vos installations sportives ? (Centre-Ville, Périphérie Aglomération, Campagne....)"} />
        ...
        <TextFieldInput onChange={handleChange('q3')} defaultValue={values.q3} label={"3. Si oui, liste des mesures :"} />
        ...
        <TextFieldInput onChange={handleChange('q7')} defaultValue={values.q7} label={"7. Si oui, liste des mesures :"} />
        ...
        <TextFieldInput onChange={handleChange('q9')} defaultValue={values.q9} label={"9. Si oui, liste des mesures :"} />
