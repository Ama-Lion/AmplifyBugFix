...
export default function GestionDesSols({ values, handleChange } ) {
    return (
        <>
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q14')} defaultValue={values.q14} label={"14. Si Oui, quel(s) type(s) de produit(s) utilisez-vous ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q16')} defaultValue={values.q16} label={"16. Si Oui, quelle(s) mesures avez-vous mis en place ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q18')} defaultValue={values.q18} label={"18. Si Oui, à quelle fréquence enregistre-vous les interventions ?"} />
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q19')} defaultValue={values.q19} label={"19. Quels indicateurs prenez-vous en compte ?"} />
            <InputRadio onChange={handleChange('q20')} defaultValue={values.q20} question="20. Avez-vous une pelouse synthétique ou hybride ?" />
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q21')} defaultValue={values.q21} label={"21. Si Oui, quel(s) système(s) avez-vous installé ?"} />
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q22')} defaultValue={values.q22} label={"22. Si vous avez fait le choix d’installer une pelouse synthétique à quelle fréquence avez-vous prévu de renouveler celle-ci ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q26')} defaultValue={values.q26} label={"26. Si Oui, quelle(s) action(s) avez-vous mis en place ? (Compostage, Méthanisation...)"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q31')} defaultValue={values.q31} label={"32. Si Oui, pouvez-vous préciser si vous avez analysé l’aire de jeu et/ou les sols autour de votre enceinte ?"} />
