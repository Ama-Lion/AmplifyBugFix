...
export default function CommunicationResponsable({ values, handleChange }) {
    return (
        <div>
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q266')} defaultValue={values.q266} label={"266. Si Oui, laquelle ou lesquelles ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q270')} defaultValue={values.q270} label={"270. Si Oui, quel(s) type(s) de programme ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q272')} defaultValue={values.q272} label={"272. Si Oui, quel type de programme ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q275')} defaultValue={values.q275} label={"275. Si Oui, avec quels outils (Ex : rapport annuel d’activité) ?"} />
            ...
            <TextField   fullWidth className="inputText TextField"t onChange={handleChange('q280')} defaultValue={values.q280} label={"280. Si Oui, Quelle(s) type(s) d’action avec quel(s) acteur(s) ?"} />
