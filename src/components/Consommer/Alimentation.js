...
export default function Alimentation({ values, handleChange }) {
    return (
        ...
        <TextFieldInput onChange={handleChange('q228')} defaultValue={values.q228} label={"228. Si Oui, Quelle(s) mesure(s) avez-vous prises ?"} />
        <TextFieldInput onChange={handleChange('q229')} defaultValue={values.q229} label={"229. Connaissez-vous la quantité de nourriture gaspillée après chaque événement ? Pouvez-vous nous l'indiquer ?"} />
        <TextFieldInput onChange={handleChange('q230')} defaultValue={values.q230} label={"230. Connaissez-vous le nombre de repas par événement (grand public et partenaires) Pouvez-vous nous donner ces chiffres moyens ?"} />
        ...
        <TextFieldInput onChange={handleChange('q232')} defaultValue={values.q232} label={"232. Si Oui, Quelle(s) mesure(s) avez-vous prises ?"} />
        ...
        <TextFieldInput onChange={handleChange('q236')} defaultValue={values.q236} label={"236. Si Oui, avec quelle(s) association(s) travaillez-vous ?"} />
        ...
        <TextFieldInput onChange={handleChange('q242')} defaultValue={values.q242} label={"242. Si Oui, avec quelle(s) méthode(s) de sensibilisation ?"} />
        ...
        <TextFieldInput onChange={handleChange('q245')} defaultValue={values.q245} label={"245. Si Oui, Quel(s) moyen(s) de prévention ?"} />
        ...
        <TextFieldInput onChange={handleChange('q248')} defaultValue={values.q248} label={"248. Si Oui, Sous quelle(s) forme(s) ou quel(s) engagement(s) ?"} />
        ...
        <TextFieldInput onChange={handleChange('q250')} defaultValue={values.q250} label={"250. Si Oui, Sous quelle(s) forme(s) ?"} />
