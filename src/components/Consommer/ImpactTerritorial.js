...
export default function ImpactTerritorial({ values, handleChange }) {
    return (
        <div>
            ...
            <TextFieldInput onChange={handleChange('q321')} defaultValue={values.q321} label={"321. Si Oui, quel(s) type(s) d’engagements ?"} />
            <TextFieldInput onChange={handleChange('q322')} defaultValue={values.q322} label={"322. Quelle(s) action(s) mettez-vous en place ?"} />
            ...
            <TextFieldInput onChange={handleChange('q324')} defaultValue={values.q324} label={"324. Si Oui, quel(s) type(s) d’engagements ?"} />
            <TextFieldInput onChange={handleChange('q325')} defaultValue={values.q325} label={"325. Quelle(s) action(s) mettez-vous en place ?"} />
            ...
            <TextFieldInput onChange={handleChange('q327')} defaultValue={values.q327} label={"327. Si oui, merci de préciser quelle(s) étude(s) et quel(s) impact(s) économique ? Social ? Écoresponsable ?"} />
            ...
            <TextFieldInput onChange={handleChange('q329')} defaultValue={values.q329} label={"329. Si Oui, pouvez-vous préciser quelques actions ?"} />
            ...
            <TextFieldInput onChange={handleChange('q331')} defaultValue={values.q331} label={"331. Si Oui, quelles sont les thématiques principales de ce parrainage ?"} />
            ...
            <TextFieldInput onChange={handleChange('q333')} defaultValue={values.q333} label={"333. Avez-vous réfléchi à l’héritage que vous souhaitez laisser sur le territoire ? (Question ouverte)"} />
