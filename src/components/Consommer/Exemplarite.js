...
export default function Exemplarite({ values, handleChange }) {
    return (
        <div>
            ...
            <TextFieldInput onChange={handleChange('q292')} defaultValue={values.q292} label={"292. Si Oui, pouvez-vous donner quelques exemples de goodies écoresponsables :"} />
            ...
            <TextFieldInput onChange={handleChange('q295')} defaultValue={values.q295} label={"295. Quel est le nom de votre équipementier ?"} />
            ...
            <TextFieldInput onChange={handleChange('q297')} defaultValue={values.q297} label={"297. Quel(s) équipement(s) avez-vous développé en commun ?"} />
            <TextFieldInput onChange={handleChange('q298')} defaultValue={values.q298} label={"298. Quel matériau avez-vous choisi de travailler ?"} />
            <TextFieldInput onChange={handleChange('q299')} defaultValue={values.q299} label={"299. Quel procédé de fabrication avez-vous choisi ?"} />
            ...
            <TextFieldInput onChange={handleChange('q301')} defaultValue={values.q301} label={"301. Quel est le nom de ce(s) sponsor (s) ?"} />
            ...
            <TextFieldInput onChange={handleChange('q303')} defaultValue={values.q303} label={"303. Si Oui, de quelle manière les met-il en avant ?"} />
            ...
            <TextFieldInput onChange={handleChange('q306')} defaultValue={values.q306} label={"306. Si Oui, de quelle manière participez-vous à cette promotion ?"} />
            ...
            <TextFieldInput onChange={handleChange('q311')} defaultValue={values.q311} label={"311. Si Oui, de quelle manière valorisez-vous vos  volontaires ?"} />
            ...
            <TextFieldInput onChange={handleChange('q313')} defaultValue={values.q313} label={"313. Si Oui, quels sont ces programmes mis en place ?"} />
            ...
            <TextFieldInput onChange={handleChange('q315')} defaultValue={values.q315} label={"315. Si Oui, quelle est la catégorie concernée ? Et sous quelle forme cet engagement se manifeste ?"} />
